...
module.exports=async(req,res)=>{
        ...
        try{
                  ...
                  try{const r=await get("/uapi/domestic-stock/v1/quotations/volume-rank","FHPST01710000",{...base,FID_COND_MRKT_DIV_CODE:"J"},tk);kospiStocks=parse(r.output);}catch(e){console.error("kospi:",e.message)}
                  await w(1500);
